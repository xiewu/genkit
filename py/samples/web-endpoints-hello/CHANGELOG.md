...
- **py/samples**: endpoints sample resilience and developer experience (8fc9567, #4547) — @Yesudeep Mangalapilly
- **py**: resolve CI license check failures and lint diagnostics (e8519ef, #4524) — @Yesudeep Mangalapilly
- **py/samples**: guard sentry import, fix dual-trace export, improve dev UX (282d988, #4503) — @Yesudeep Mangalapilly
